...
<link rel="stylesheet" href="<%=rootCss%>cscenter/qna.css">
<script type="text/javascript" src="<%=rootJS%>cscenter/qna.js" /></script>
<title>Korail</title>
</head>
<body>
	...
	<form id="pagingInfo">
			...
			<input type="hidden"  id="ispublic" class="ispublic" name="ispublic" value="0"/>
