...
<link rel="stylesheet" href="<%=rootCss%>boardmgr/faq/faqList.css">
<script type="text/javascript" src="<%=rootJS%>boardmgr/faq/faqList.js" /></script>
<title>Korail</title>
</head>
<body>
	<%-- <input type="hidden"  id="tpublic" class="tpublic" name="tpublic" value="${tpublic}"/> --%>
	<form id="pagingInfo">
			...
			<div class="container faqWrap">
				<section>
					...
					<div class="pagingNavi">
						...
						<button type="button" id="faqwrite" class="ui-button ui-corner-all ui-widget swrite">글쓰기</button>
					</div>
				</section>
			</div>
		</div>
